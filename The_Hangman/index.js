...
window.onload = function () {
  ...
  comments = function () {
    ...
    lose = [
      ...
      ", Muderer!",
      ", look how you killed my boy!",
    ];

    win = [
      ", my boy! Congratulations!",
      ", you did it. OMG!",
      ", right? Well it was easy.",
      ", good job there!",
    ];
  ...
  hint.onclick = function () {
    hints = [
      [
        "What makes you a North Indian",
        "Palak---, shahi---, kadai---",
        "no more kook do koo",
        "tikka, lol",
        "earthworms?",
        "Definately not with Pineapple",
        "Without Sambar?",
        "gujjus' mithai",
      ],

      [
        "popular series of horror films",
        "1957 Historical drama. Nargis Dutt aka Radha",
        "Maximus Decimus Meridius",
        "Anamated Fish",
        "Utha le re baba",
        "Teaparty, Cards, Cat",
        "Chocolate, Vietnam, Leg Braces",
        "A Cowboy, An Astronaut",
        "White Rabbit, Zion, Sentinel",
      ],

      [
        "An ancient city of Kuru Kingdom",
        "Home of marshall Mathers",
        "KPOP",
        "Ends with sea",
        "Konichiwa",
        "Indian Militry Academy",
        "Laxminagar",
        "land of materialism, rich tourists, khalifa",
        "big-ben",
        "terrorists and isi",
      ],
